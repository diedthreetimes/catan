public class Board {
	...
	
	{
		resources[0] = new Resource[] {
			null,
			null,
			new Resource(Card.Type.WOOD, 11),
			null,
			new Resource(Card.Type.SHEEP, 12),
			null,
			new Resource(Card.Type.WHEAT, 9),
			null,
			null};
		resources[1] = new Resource[] {
			null,
			new Resource(Card.Type.BRICK, 4),
			null,
			new Resource(Card.Type.ORE, 6),
			null,
			new Resource(Card.Type.BRICK, 5),
			null,
			new Resource(Card.Type.SHEEP, 10),
			null};
		resources[2] = new Resource[] {
			new Resource(null, 0),
			null,
			new Resource(Card.Type.WOOD, 3),
			null,
			new Resource(Card.Type.WHEAT, 11),
			null,
			new Resource(Card.Type.WOOD, 4),
			null,
			new Resource(Card.Type.WHEAT, 8)};
		resources[3] = new Resource[] {
			null,
			new Resource(Card.Type.BRICK, 8),
			null,
			new Resource(Card.Type.SHEEP, 10),
			null,
			new Resource(Card.Type.SHEEP, 9),
			null,
			new Resource(Card.Type.ORE, 3),
			null};
		resources[4] = new Resource[] {
			null,
			null,
			new Resource(Card.Type.ORE, 5),
			null,
			new Resource(Card.Type.WHEAT, 2),
			null,
			new Resource(Card.Type.WOOD, 6),
			null,
			null};
		spaces[0] = new Point[] {
			null,
